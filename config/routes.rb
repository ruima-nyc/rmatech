ActionController::Routing::Routes.draw do |map|
  ...
  map.admin '/admin', :controller => 'users', :action => 'admin'
  map.imagecode '/imagecode', :controller => 'sessions', :action => 'imagecode'
  map.rpx_login '/rpx_login', :controller => 'sessions', :action => 'rpx_login'
  ...
  map.mypage '/:id', :controller => 'users',:action => 'show'
end
